  ...
  moodboard: {
    toolCall: {
      ...
      args: {
        ...
        theme: "vibrant",
        concepts: ["Bold", "Dynamic", "Fresh", "Innovative"],
      },
    },
  },
  calm: {
    toolCall: {
      ...
      args: {
        ...
        title: "Zen Space",
        theme: "minimal",
        concepts: ["Peace", "Balance", "Simplicity", "Harmony"],
      },
    },
  },
  nature: {
    toolCall: {
      ...
      args: {
        ...
        title: "Nature Escape",
        theme: "nature",
        concepts: ["Growth", "Organic", "Life", "Green"],
      },
    },
  },
  hello: {
    content: "Hello! I can help you create mood boards. Try saying 'create a mood board for...'",
  },
  default: {
    content: "I understand. Would you like to create a mood board to capture your inspiration?",
  },
};
...
export const findMockResponse = (
  ...
  if (lowerMessage.includes("mood") || lowerMessage.includes("board") || lowerMessage.includes("inspiration")) {
    return mockResponses.moodboard || DEFAULT_MOCK_RESPONSES.moodboard;
  }
  if (lowerMessage.includes("calm") || lowerMessage.includes("zen") || lowerMessage.includes("minimal")) {
    return mockResponses.calm || DEFAULT_MOCK_RESPONSES.calm;
  }
  if (lowerMessage.includes("nature") || lowerMessage.includes("green") || lowerMessage.includes("organic")) {
    return mockResponses.nature || DEFAULT_MOCK_RESPONSES.nature;
  }
